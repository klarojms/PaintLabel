...
/**
  XXX
 */
typedef ERRCODE (TEC_CALLBACK *fn_DrawColoredBar)  (VOID* customData, HDC drawDC, DOUBLE x, DOUBLE y, DOUBLE width, DOUBLE height, COLORREF color);
...
TBARCODEDLL_API ERRCODE TECIT_STDCALL BCSetTextEBCDIC(INT nCodepage, t_BarCode* pBarCode, LPCSTR szText, LONG nLen);
...
TBARCODEDLL_API fn_DrawColoredBar TECIT_STDCALL BCGetFuncDrawColoredBar(t_BarCode* pBarCode);
TBARCODEDLL_API ERRCODE TECIT_STDCALL BCSetFuncDrawColoredBar(t_BarCode* pBarCode, fn_DrawColoredBar fn);
