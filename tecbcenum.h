...
/* eBC_PPN,                 1:1                         (1B:1S)                             eCDNone                                             */
/* eBC_NTIN,                1:1                         (1B:1S)                             eCDEAN14                                            */
/* eBC_SwissQrCode,         1:1                         (1B:1S)                             ----                                                */
...
/// @endcond 
{
  ...
  TECIT_HS("MaxiCode")                        eBC_MAXICODE    = 57,       ///< <b> MaxiCode </b>\n Enumeration Value: 57
                                                                          ...
                                                                          ///< \n\n
  TECIT_HS("QR-Code (JIS)")                   eBC_QRCode_JIS   = 58,      ///< <b> QR-Code (JIS) </b>\n Enumeration Value: 58
                                                                          ...
                                                                          ///< \n
  TECIT_HS("QR-Code (JIS - deprecated)")      eBC_QRCode      = 58,       ///< <b> QR-Code (JIS) - deprecated </b>\n Enumeration Value: 58
  ...
  TECIT_HS("HIBC PAS CODABLOCK-F")        eBC_HIBCPasCODABLOCK_F = 111,   ///< <b> HIBC PAS CODABLOCK-F </b>\n Enumeration Value: 111
                                                                          ...
                                                                          ///< \n For a short format description see also #eBC_HIBCPas128 (Primary and Combined Format, splitting is not allowed).
                                                                          ///< \n\n
  TECIT_HS("QR-Code")                         eBC_QRCode_ISO = 112,       ///< <b> QR-Code (ISO)  </b>\n Enumeration Value: 112
                                                                          ...
                                                                          ///< \n\n
  TECIT_HS("QR-Code 2005 (ISO - deprecated)") eBC_QRCode2005 = 112,       ///< <b> QR-Code 2005 (ISO) - deprecated  </b>\n Enumeration Value: 112
  ...
  TECIT_HS("HIBC PAS Aztec Code")             eBC_HIBCPasAztec = 123,     ///< <b> HIBC PAS Aztec Code </b>\n Enumeration Value: 123
                                                                          ...
                                                                          ///< \n For a short format description see also #eBC_HIBCPas128 (Primary and Combined Format, splitting is not allowed).
                                                                          ///< \n\n
  TECIT_HS("PPN")                             eBC_PPN = 124,              ///< <b> PPN (Pharmacy Product Number) </b> \n Enumeration Value: 124
                                                                          ///< \n PPN uses Data Matrix as base symbology, with the format Macro06; It has 2 special check digits (modulo 97) and 
                                                                          ///     can be extended by a serial number, a batch number, and an expiry date.
                                                                          ...
                                                                          ///< \n For German PPN codes the check digit is calculated automatically if the given code is not longer than 12 digits. 
                                                                          ///     For other countries no check digit calculation is supported so far.
                                                                          ///< - Can contain following sub fields:
                                                                          ///    + Product Code: "9N" + PRA + RPN + CC 
                                                                          ///      with:
                                                                          ///      PRA  ... PRA-Code ("00" - "99", "AA" - "ZZ"), "11" for Germany
                                                                          ///      RPN  ... Registered Product Number (["0" - "9", "A" - "Z"], 1-18 characters)
                                                                          ///      CC   ... check sum; 2 check digits mod-97
                                                                          ///    + NTIN: "8P" + NTIN (optional)
                                                                          ///      with:
                                                                          ///      NTIN ... National Trade Item Number (14 digits)
                                                                          ///    + Serial Number: "S" + SN (optional)
                                                                          ///      with:
                                                                          ///      SN   ... Serial Number (alphanumeric, 1-20 characters)
                                                                          ///    + Batch Number: "1T" + BN (optional)
                                                                          ///      with:
                                                                          ///      BN   ... Batch Number (alphanumeric, 1-20 characters)
                                                                          ...
                                                                          ///< \n\n
  TECIT_HS("NTIN (Data Matrix)")              eBC_NTIN = 125,             ///< <b> NTIN (National Trade Item Number) </b> \n Enumeration Value: 125
                                                                          ///< \n NTIN uses Data Matrix as base symbology, with the GS1 format; It has a special check digits (#eCDEAN14) and 
                                                                          ///     can be extended by a serial number, a batch number, and an expiry date.
                                                                          ...
                                                                          ///< \n For German NTIN codes the check digit is calculated automatically if the given code is not longer than 13 digits. 
                                                                          ///     For other countries no check digit calculation is supported so far.
                                                                          ///< - Can contain following sub fields:
                                                                          ///    + Product Code: "01" + "0" + PREF + PN + CD    (total exact 14 digits)
                                                                          ///      with:
                                                                          ///      PREF ... GS1 Prefix or Base Number, "4150" for Germany
                                                                          ///      PN   ... Product Number
                                                                          ///      CD   ... check digit
                                                                          ///    + Serial Number: "21" + SN (optional)
                                                                          ///      with:
                                                                          ///      SN   ... Serial Number (alphanumeric, 1-20 characters)
                                                                          ///    + Batch Number: "10" + BN (optional)
                                                                          ///      with:
                                                                          ///      BN   ... Batch Number (alphanumeric, 1-20 characters)
                                                                          ...
                                                                          ///< - Recommended check digit methods: #eCDStandard (#eCDEAN14)
                                                                          ///< \n\n
  TECIT_HS("Swiss QR Code")                   eBC_SwissQrCode = 126,      ///< <b> Swiss QR Code </b> \n Enumeration Value: 126
                                                                          ...
                                                                          ///< \n Codeable character set: ISO-8859-1
                                                                          ///< - Default check-digit method: None
                                                                          ///< - Recommended check digit methods:  None (Error correction and recognition depends on adjusted Error Correction Level)\n
                                                                          ///< \n\n
...
/// @endcond 
{
    ...
    TECIT_HS("8   x 48")                            eDMSz_8x48,     ///< =31: Fixed rectangular symbol-size   8 x 48  (ISO21471)
    TECIT_HS("8   x 64")                            eDMSz_8x64,     ///< =32: Fixed rectangular symbol-size   8 x 64  (ISO21471)
    TECIT_HS("12  x 64")                            eDMSz_12x64,    ///< =33: Fixed rectangular symbol-size  12 x 64  (ISO21471)
    TECIT_HS("16  x 64")                            eDMSz_16x64,    ///< =34: Fixed rectangular symbol-size  16 x 64  (ISO21471)
    ...
    TECIT_HS("24  x 48")                            eDMSz_24x48,    ///< =37: Fixed rectangular symbol-size  24 x 48  (ISO21471)
    TECIT_HS("24  x 64")                            eDMSz_24x64,    ///< =38: Fixed rectangular symbol-size  24 x 64  (ISO21471)
    TECIT_HS("26  x 32")                            eDMSz_26x32,    ///< =39: Fixed rectangular symbol-size  26 x 32  (DMRE)
    TECIT_HS("26  x 40")                            eDMSz_26x40,    ///< =40: Fixed rectangular symbol-size  26 x 40  (ISO21471)
    TECIT_HS("26  x 48")                            eDMSz_26x48,    ///< =41: Fixed rectangular symbol-size  26 x 48  (ISO21471)
    TECIT_HS("26  x 64")                            eDMSz_26x64,    ///< =42: Fixed rectangular symbol-size  26 x 64  (ISO21471)
    // ISO/IEC WD 21471
    ...
    TECIT_HS("22  x 40")                            eDMSz_22x40,    ///< =51: Fixed rectangular symbol-size  22 x 40  (deprecated, removed from ISO draft)
